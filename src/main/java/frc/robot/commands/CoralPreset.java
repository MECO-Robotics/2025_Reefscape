...
public class CoralPreset {
  ...
  public CoralPreset(String name, double elevatorPosMeters, Rotation2d wristPos) {
    this.elevatorPos = new LoggedTunableNumber("CoralPresets/" + name + "/elevatorPos", elevatorPosMeters);
    this.wristPos = new LoggedTunableNumber("CoralPresets/" + name + "/wristPos", wristPos.getDegrees());
  }
