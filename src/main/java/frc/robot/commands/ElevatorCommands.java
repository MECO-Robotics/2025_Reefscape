...
public class ElevatorCommands {
	...
	public static final class ELEVATOR_HEIGHT_PRESETS {
		...
		public static final CoralPreset SAFE = new CoralPreset("SAFE", 0.25, Rotation2d.fromRotations(0));
		...
		public static final CoralPreset L_FOUR_CORAL = new CoralPreset("L4", 1.01, Rotation2d.fromRotations(0.16));
		...
		public static final CoralPreset WAIT_FOR_CORAL = new CoralPreset("Wait_for_Coral", 0.2,
		...
		return Commands.either(
				...
				PositionJoint.setPosition(elevatorMotor, () -> preset.getElevatorPos())
						.alongWith(
								...
								Commands.waitUntil(() -> elevatorMotor.getPosition() > ELEVATOR_HEIGHT_PRESETS.SAFE
										.getElevatorPos())
				...
				PositionJoint.setPosition(elevatorMotor, () -> ELEVATOR_HEIGHT_PRESETS.SAFE.getElevatorPos())
					//move wrist right after in safe position
						.andThen(PositionJoint.setPosition(wristMotor,
								() -> preset.getWristPos().getRotations())
						//wait for the wrist position to be 0 (horizontal position), then move the elevator again
							.alongWith(Commands.waitUntil(() -> wristMotor
							.getPosition() > ELEVATOR_HEIGHT_PRESETS.SAFE.getWristPos().getRotations()))
	...
	public static Command handOff(PositionJoint elevatorMotor, PositionJoint wristMotor) {
		...
		return Commands.waitUntil(() -> elevatorMotor.getPosition() > ELEVATOR_HEIGHT_PRESETS.HANDOFF.getElevatorPos())
