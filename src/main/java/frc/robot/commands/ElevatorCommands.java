...
public class ElevatorCommands {
    ...
    public static final class ELEVATOR_HEIGHT_PRESETS {
        ...
        public static final CoralPreset L_TWO_CORAL = new CoralPreset("L2", 0.15, Rotation2d.fromDegrees(30));

        public static final CoralPreset L_THREE_CORAL = new CoralPreset("L3", 0.41, Rotation2d.fromRotations(0.15));

        public static final CoralPreset L_FOUR_CORAL = new CoralPreset("L4", 1.0, Rotation2d.fromRotations(0.16));
    ...
    public static Command handOff(PositionJoint elevatorMotor, PositionJoint wristMotor, Flywheel endEffectorMotor) {
