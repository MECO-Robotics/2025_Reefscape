...
public class ElevatorCommands {
  ...
  public static final class ELEVATOR_HEIGHT_PRESETS {
    ...
    public static final CoralPreset WAIT_FOR_CORAL =
        new CoralPreset("Wait for Coral", 0.2, Rotation2d.fromRotations(-0.25));
  }
                        ...
                        Commands.waitUntil(
                            () ->
                                wristMotor.getPosition()
                                    > ELEVATOR_HEIGHT_PRESETS.MID.getWristPos().getRotations()))
                    .andThen(
                        PositionJoint.setPosition(elevatorMotor, () -> preset.getElevatorPos()))),
  ...
  public static Command handOff(PositionJoint elevatorMotor, PositionJoint wristMotor) {
    return Commands.waitUntil(
        ...
        .deadlineFor(
            PositionJoint.setPosition(
                elevatorMotor, () -> ELEVATOR_HEIGHT_PRESETS.MID.getElevatorPos()))
        .andThen(
            PositionJoint.setPosition(
