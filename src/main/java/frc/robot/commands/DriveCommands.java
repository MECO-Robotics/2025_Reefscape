...
public class DriveCommands {
  ...
  private static final LoggedTunableNumber APPROACH_SPEED = new LoggedTunableNumber("Approach Speed", 1.0);
  ...
  public static final Command joystickDriveToReef(Drive drive, Vision vision,
      DoubleSupplier xSupplier,
      DoubleSupplier ySupplier,
      DoubleSupplier omegaSupplier) {
    ...
    return Commands.run(
        () -> {
            ...
            switch (vision.getTagID()) {
              case 6:
                omega = angleController.calculate(
                    drive.getRotation().getRadians(), Rotation2d.fromDegrees(120).getRadians());
                break;
              case 7:
                omega = angleController.calculate(
                    drive.getRotation().getRadians(), Rotation2d.fromDegrees(180).getRadians());
                break;
              case 8:
                omega = angleController.calculate(
                    drive.getRotation().getRadians(), Rotation2d.fromDegrees(-120).getRadians());
              ...
              case 9:
                omega = angleController.calculate(
                    drive.getRotation().getRadians(), Rotation2d.fromDegrees(-60).getRadians());
                break;
              case 10:
                omega = angleController.calculate(
                    drive.getRotation().getRadians(), Rotation2d.fromDegrees(0).getRadians());
                break;
              case 11:
                omega = angleController.calculate(
                    drive.getRotation().getRadians(), Rotation2d.fromDegrees(60).getRadians());
          ...
          double headingEffort = REEF_P.get() * vision.getLatestTargetObservation().tx().getRadians();
          ...
          if (vision.hasTarget()) {
            ...
            if (angleController.atGoal() && Math.abs(vision.getLatestTargetObservation().tx().getRadians()) < 0.1) {
