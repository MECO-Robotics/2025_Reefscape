...
public class VisionIOPhotonVisionGoon implements VisionIO {
   ...
   */
  public VisionIOPhotonVisionGoon(
  ...
  public void updateInputs(VisionIOInputs inputs) {
    ...
    for (var result : camera.getAllUnreadResults()) {
      ...
      if (result.hasTargets()) {
        ...
        double distance =
            LinearInterpolationTable.table.getOutput(result.getBestTarget().getPitch())
                / Math.sin(ty);
