...
public class PositionJointConstants {
  ...
  // Coral Intake
  public static final PositionJointGains CORAL_INTAKE_ROTATION_GAINS = new PositionJointGains(20, 0, 0, 0.25, 0.85, 0,
      0, 0, 0, -6, 0, 0, 0);
  ...
  public static final class CORAL_ROTATION_POSITIONS {
    public static final double UP = 0; // -0.28;
    public static final double DOWN = 101.0 / 360.0; // -5.85;
  }
