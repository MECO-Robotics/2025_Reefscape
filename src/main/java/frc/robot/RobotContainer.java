...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("AlignToLeftReef",
                Commands.either(Commands.run(() -> AdvancedPPHolonomicDriveController
                        .overrideYFeedback(() -> vision.getLatestTargetObservation()[0].ty().getRadians()
                                * DriveCommands.REEF_P.get())),
                        Commands.run(() -> AdvancedPPHolonomicDriveController
                                .overrideYFeedback(() -> 0.0)),
                        () -> vision.hasTarget()[0]));

        NamedCommands.registerCommand("AlignToRightReef",
                Commands.either(Commands.run(() -> AdvancedPPHolonomicDriveController
                        .overrideYFeedback(() -> vision.getLatestTargetObservation()[1].ty().getRadians()
                                * DriveCommands.REEF_P.get())),
                        Commands.run(() -> AdvancedPPHolonomicDriveController
                                .overrideYFeedback(() -> 0.0)),
                        () -> vision.hasTarget()[1]));
